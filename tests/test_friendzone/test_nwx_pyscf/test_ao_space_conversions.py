...
from friendzone.nwx_pyscf.ao_space_conversions import (atom_to_ao,
                                                       convert_to_pyscf)
from mokup import mokup
from .test_nwx_pyscf import (string_geoms, compare_pyscf_basis,
                             compare_pyscf_mol)
import pyscf
...
class TestAOSpaceConversions(unittest.TestCase):
    ''' Tests functionality found in the
        friendzone.nwx_pyscf.ao_space_conversions module.
