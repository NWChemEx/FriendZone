...
from friendzone.nwx_pyscf.molecule_conversions import (convert_to_pyscf,
                                                   convert_from_pyscf)
from mokup import mokup
from .test_nwx_pyscf import compare_pyscf_mol, string_geoms


class TestMoleculeConversions(unittest.TestCase):
    '''Tests functionality found in the
       friendzone.nwx_pyscf.molecule_conversions module.
